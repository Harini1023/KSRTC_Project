...
public class Booking extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        proccedPay.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "select * from AvailableBuses where from_place="+"'"+textvalue2+"'"+"and destination="+"'"+textvalue3+"'"+"and start_date="+"'"+textvalue6+"'";
    ...
    }//GEN-LAST:event_proccedPayActionPerformed

    private void seatsSelectedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_seatsSelectedActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_seatsSelectedActionPerformed
